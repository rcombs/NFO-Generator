...
var tmdb = function(api_key, language) {
	...
	this.api_urls =
		{
			configuration:              this.base+'/configuration?language='+this.language+'&api_key='+this.api_key,
			misc_latest:                this.base+'/latest/movie?language='+this.language+'&api_key='+this.api_key,
			misc_now_playing:           this.base+'/movie/now-playing?page={0}&language='+this.language+'&api_key='+this.api_key,
			misc_popular:               this.base+'/movie/popular?page={0}&language='+this.language+'&api_key='+this.api_key,
			misc_top_rated:             this.base+'/movie/top-rated?page={0}&language='+this.language+'&api_key='+this.api_key,
			movie_info:                 this.base+'/movie/{0}?language='+this.language+'&api_key='+this.api_key,
			movie_alternative_titles:   this.base+'/movie/{0}/alternative_titles?language='+this.language+'&api_key='+this.api_key,
			movie_casts:                this.base+'/movie/{0}/casts?language='+this.language+'&api_key='+this.api_key,
			movie_images:               this.base+'/movie/{0}/images?language='+this.language+'&api_key='+this.api_key,
			movie_keywords:             this.base+'/movie/{0}/keywords?language='+this.language+'&api_key='+this.api_key,
			movie_releases:             this.base+'/movie/{0}/releases?language='+this.language+'&api_key='+this.api_key,
			movie_trailers:             this.base+'/movie/{0}/trailers?language='+this.language+'&api_key='+this.api_key,
			movie_translations:         this.base+'/movie/{0}/translations?language='+this.language+'&api_key='+this.api_key,
            movie_similar:              this.base+'/movie/{0}/similar_movies?page={1}&language='+this.language+'&api_key='+this.api_key,
			person_info:                this.base+'/person/{0}?language='+this.language+'&api_key='+this.api_key,
			person_credits:             this.base+'/person/{0}/credits?language='+this.language+'&api_key='+this.api_key,
			person_images:              this.base+'/person/{0}/images?language='+this.language+'&api_key='+this.api_key,
			collection_info:            this.base+'/collection/{0}?language='+this.language+'&api_key='+this.api_key,
			search_movie:               this.base+'/search/movie?query={0}&page={1}&language='+this.language+'&api_key='+this.api_key,
			search_person:              this.base+'/search/person?query={0}&page={1}&language='+this.language+'&api_key='+this.api_key,
			auth_request_token:			this.base+'/authentication/token/new?language='+this.language+'&api_key='+this.api_key,
			auth_session_id:			this.base+'/authentication/session/new?request_token={0}&language='+this.language+'&api_key='+this.api_key,
			write_rate_movie:			this.base+'/movie/{0}/rating?session_id={1}&language='+this.language+'&api_key='+this.api_key,
            company_info:               this.base+'/company/{0}?language='+this.language+'&api_key='+this.api_key,
            company_movies:             this.base+'/company/{0}/movies?language='+this.language+'&api_key='+this.api_key,
            account_info:               this.base+'/account?session_id={0}&language='+this.language+'&api_key='+this.api_key,
            account_favorite_movies:    this.base+'/account/{0}/favorite_movies?session_id={1}&language='+this.language+'&api_key='+this.api_key,
            account_rated_movies:       this.base+'/account/{0}/rated_movies?session_id={1}&language='+this.language+'&api_key='+this.api_key,
            account_add_favorite:       this.base+'/account/{0}/favorite?session_id={1}&language='+this.language+'&api_key='+this.api_key,
		};
...
module.exports.init = function(apikey, language) {
	return new tmdb(apikey, (language || "en"));
};
